...
public class Dijkstra {
    ...
    private  List<List<List<Integer>>> Pi;
    private  int arrSize;
    ...
    public boolean connectionExists(int start, int end) throws Exception{
        init();
        for (int i = 0; i < arrSize; i++) {
            dijkstraAlg(i);
        }
        return getInfo(start, end);
    }

    public void dijkstraAlg(int source) {
    ...
    private  Set<Integer> getNeighbors(int vertex) {
    ...
    private  void remove(List<Integer> lst, int vert) {
    ...
    private  int getMinFromQ(List<Integer> lst, Integer[] arr) {
    ...
    private boolean getInfo(int i, int j) {
